...
@XmlRootElement(name = "DllGetCardParktime")
public class DllGetCardParktime {

	@XmlElementRef(name = "json", namespace = "http://service.geweb.com", type = JAXBElement.class)
	...
	public void setJson(JAXBElement<String> value) {
		this.json = ((JAXBElement<String>) value);
	}
