...
@XmlRootElement(name = "DllGetCardParktimeResponse")
public class DllGetCardParktimeResponse {

	@XmlElementRef(name = "return", namespace = "http://service.geweb.com", type = JAXBElement.class)
